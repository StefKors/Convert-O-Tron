<p align="center">
  <img src="Convert-O-Tron/Assets.xcassets/AppIcon.appiconset/AppIcon-1024.png" height="128">
  <h1 align="center">Convert-O-Tron</h1>
</p>

![Convert-O-Tron](https://github.com/StefKors/Convert-O-Tron) is a little tool to convert `.opml` files to markdown and import them into Ulysses.
...
<picture>
  ...
  <img alt="Screenshot of Convert-O-Tron" src="Images/Screenshot-light.png">
</picture>
